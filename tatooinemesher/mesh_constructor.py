            ...
            if len(common_limits_id) < 2:
                ...
                for j, (id1, id2) in enumerate(zip(common_limits_id, common_limits_id[1:])):
                    ...
                    L1_z_dev, L1_gap = self._compute_line_z_correction(
                        constraint_lines[id1], Xp_profil1_L1, Xp_profil2_L1, L1_coord_int, Xp_adm_list,
                        z_sec_us_L1, z_sec_ds_L1, self.z_line_strength,
                    )
                    L2_z_dev, L2_gap = self._compute_line_z_correction(
                        constraint_lines[id2], Xp_profil1_L2, Xp_profil2_L2, L2_coord_int, Xp_adm_list,
                        z_sec_us_L2, z_sec_ds_L2, self.z_line_strength,
                    )
